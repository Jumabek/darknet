...
patch_region_layer make_patch_region_layer(int batch, int w, int h, int classes, int coords)
{
...
box patch_get_region_box(float *x, float *biases, int n, int index, int i, int j, int w, int h)
{
	box b;
...
void forward_patch_region_layer(const region_layer l, network_state state)
{
	int i, j, b, t, n;
...
void backward_patch_region_layer(const region_layer l, network_state state)
{
...
void forward_patch_region_layer_gpu(const region_layer l, network_state state)
{
	/*
	if(!state.train){
...
void backward_patch_region_layer_gpu(region_layer l, network_state state)
{
